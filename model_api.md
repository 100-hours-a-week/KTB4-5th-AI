...
2단계의 외부 영수증 21장 최초 평가에서는 상품행 정밀도 95.6%, 재현율 81.1%, 종합점수 87.8%였습니다. 고정 설정으로 세 번 반복한 현재 기준은 정밀도 95.1%, 재현율 73.6%, 종합점수 83.0%였고 전체 95% 완료시간도 18.44초였습니다. 목표인 상품행 재현율·종합점수 90%와 긴 영수증 95% 완료시간 12초를 충족하지 못했으므로 현재 파이프라인을 자동 등록 모델로 승인하지 않습니다.
